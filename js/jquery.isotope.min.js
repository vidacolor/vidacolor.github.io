...
t=r(t)
for(var e=0,o=a.length;o>e;e++)if(i=a[e]+t,"string"==typeof s[i])return i},l=h("transform"),u=h("transitionProperty"),c={csstransforms:function(){return!!l},csstransforms3d:function(){var t=!!h("perspective")
...
if(r=!0,a=function(){if(!c){for(var i,s=0,e=d.length;e>s;s++)i=d[s],"function"==typeof i&&i.call(f.element,t,f)
...
s._masonryPlaceBrick(t,h)}})},_masonryPlaceBrick:function(t,i){for(var s=Math.min.apply(Math,i),e=0,n=0,o=i.length;o>n;n++)if(i[n]===s){e=n
break}var r=this.masonry.columnWidth*e,a=s
this._pushPosition(t,r,a)
var h=s+t.outerHeight(!0),l=this.masonry.cols+1-o
for(n=0;l>n;n++)this.masonry.colYs[e+n]=h},_masonryGetContainerSize:function(){var t=Math.max.apply(Math,this.masonry.colYs)
return{height:t}},_masonryResizeChanged:function(){return this._checkIfSegmentsChanged()},_fitRowsReset:function(){this.fitRows={x:0,y:0,height:0}},_fitRowsLayout:function(t){var s=this,e=this.element.width(),n=this.fitRows
...
s._masonryHorizontalPlaceBrick(t,h)}})},_masonryHorizontalPlaceBrick:function(t,i){for(var s=Math.min.apply(Math,i),e=0,n=0,o=i.length;o>n;n++)if(i[n]===s){e=n
break}var r=s,a=this.masonryHorizontal.rowHeight*e
this._pushPosition(t,r,a)
var h=s+t.outerWidth(!0),l=this.masonryHorizontal.rows+1-o
for(n=0;l>n;n++)this.masonryHorizontal.rowXs[e+n]=h},_masonryHorizontalGetContainerSize:function(){var t=Math.max.apply(Math,this.masonryHorizontal.rowXs)
return{width:t}},_masonryHorizontalResizeChanged:function(){return this._checkIfSegmentsChanged(!0)},_fitColumnsReset:function(){this.fitColumns={x:0,y:0,width:0}},_fitColumnsLayout:function(t){var s=this,e=this.element.height(),n=this.fitColumns
t.each(function(){var t=i(this),o=t.outerWidth(!0),r=t.outerHeight(!0)
...
n.src!==a&&-1===i.inArray(n,h)&&(h.push(n),--r<=0&&(setTimeout(s),o.unbind(".imagesLoaded",e)))}var n=this,o=n.find("img").add(n.filter("img")),r=o.length,a="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==",h=[]
...
i.fn.isotope=function(t,e){if("string"==typeof t){var n=Array.prototype.slice.call(arguments,1)
this.each(function(){var e=i.data(this,"isotope")
return e?i.isFunction(e[t])&&"_"!==t.charAt(0)?(e[t].apply(e,n),s):(z("no such method '"+t+"' for isotope instance"),s):(z("cannot call methods on isotope prior to initialization; attempted to call method '"+t+"'"),s)})}else this.each(function(){var s=i.data(this,"isotope")
s?(s.option(t),s._init(e)):i.data(this,"isotope",new i.Isotope(t,this,e))})
